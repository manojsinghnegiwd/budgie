...
import { RefreshCw, SlidersHorizontal, ChevronUp } from "lucide-react";
...
export function DashboardControls({ categories, month, year }: DashboardControlsProps) {
  ...
  const { selectedUserId, viewUserId } = useUser();
  ...
  const hasActiveFilters = month !== currentMonth || year !== currentYear || viewUserId !== "all";
    ...
    <>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="hidden md:flex md:items-center md:gap-2">
          ...
          <CategoryFilter categories={categories} className="w-[160px]" />
          <Select
      ...
      <div className={cn(
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2">
          ...
          <CategoryFilter categories={categories} className="w-full md:w-[160px]" />
          <div className="flex items-center gap-2">
            <Select
              value={month.toString()}
              onValueChange={updateMonth}
